...
export default function Footer() {
  return (
    <footer className="relative bg-[#1B0B2B] text-white py-10 px-6 md:px-12 ml-40 border-t border-white/10">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        {/* Nama / Logo */}
        <h2 className="text-2xl font-bold tracking-wide cursor-default">
        ...
        <div className="flex items-center gap-5">
          <button
            onClick={() =>
              window.open("https://www.linkedin.com/in/muhammad-kahfi-537941377", "_blank")
            }
            className="hover:text-[#FFB347] transition-colors duration-300"
            aria-label="LinkedIn"
          >
          ...
          <button
            onClick={() =>
              window.open("https://www.instagram.com/sk3choo/", "_blank")
            }
            className="hover:text-[#FFB347] transition-colors duration-300"
