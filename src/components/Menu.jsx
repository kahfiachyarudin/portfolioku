...
function Menu() {
  ...
  const desktopMenuClasses = `fixed top-0 left-0 h-full bg-[#1B0B2B] shadow-lg flex flex-col items-center py-3 z-50 transition-all duration-500 ease-in-out w-64 transform ${
  ...
  return (
    <>
      ...
      {isVisible && (
        <button 
          className="fixed top-4 left-4 z-[60] md:hidden py-2 px-4 text-white bg-[#7B2CBF] hover:bg-[#F76D71] rounded-lg transition-all duration-300 shadow-lg" 
      ...
      <div className={`${desktopMenuClasses} menu-container`}>
        ...
        <div className="mb-10">
          <ul className="text-white space-y-6 text-center">
            {["home", "about", "skill", "projects", "contact", "achievement"  
            ].map((item) => (
              <li key={item} className="font-bold transition">
                <button
                  onClick={() => scrollToSection(item) || handleLinkClick()}
                  className="text-white transition-all hover:bg-gradient-to-r hover:from-[#7B2CBF] hover:via-[#F76D71] hover:to-[#FFB347] hover:bg-clip-text hover:text-transparent"
                >
        ...
        <div className="mt-auto mb-5">
          <div className="text-white flex flex-row items-center gap-5 w-full justify-center">
            {/* Social icons */}
            <button className="text-white hover:text-[#FFB347] hover:scale-105 transition-colors duration-300"  onClick={() => window.open("https://www.linkedin.com/in/muhammad-kahfi-537941377", "_blank")}>
            ...
            <button className="text-white hover:text-[#FFB347] hover:scale-105 transition-colors duration-300" onClick={() => window.open("https://www.instagram.com/sk3choo/", "_blank")}>
            ...
            <button className="text-white hover:text-[#FFB347] hover:scale-105 transition-colors duration-300" onClick={() => window.open("https://wa.me/628999717898", "_blank")}>
