...
function Contact() {
  ...
  return (
    <section
      ...
      className="pt-40 flex flex-col md:flex-row justify-center items-center min-h-screen md:ml-40 gap-10 px-6 md:px-12 py-10"
    >
      {/* Bagian Contact Details */}
      <div className="px-6 py-10 flex flex-col gap-6 text-left bg-gray-100/60 backdrop-blur-md shadow-xl rounded-2xl w-full md:w-2/3 border border-gray-300">
        <h2 className="text-2xl font-semibold mb-4 border-b pb-2 bg-gradient-to-l from-secondary to-primary text-transparent bg-clip-text">
          Contact Details
        </h2>
      ...
      <div className="px-6 py-10 flex flex-col gap-6 text-center bg-gray-100/60 backdrop-blur-md shadow-xl rounded-2xl w-full md:w-1/3 border border-gray-300">
        ...
        <form ref={formRef} onSubmit={sendEmail} className="flex flex-col gap-4 w-full">
          <input
            ...
            className="px-4 py-2 rounded-lg border border-gray-300 bg-white/80"
            required
          />
          <input
            type="email"
          ...
          <button
            type="submit"
            className="text-white py-2 rounded-lg font-medium bg-brand-gradient hover:scale-105 active:scale-95"
          >
            Send Message
          </button>
        </form>
